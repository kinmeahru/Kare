...
if(lang === 'en') {
    ...
    if(!message.channel.nsfw) {
      return message.reply({embed : {
				description : `${user} This channel doesn't support nsfw content!`,
				color : error_color
			}})
    ...
    akanekoSan.setImage(akaneko.nsfw.netorare()).setFooter(bot_name)
...
if(lang === 'de') {
	   if(!message.channel.nsfw) {
      return message.reply({embed : {
				description : `${user} Dieser Channel unterstützt keine NSFW-Inhalte`,
				color : error_color
			}})
